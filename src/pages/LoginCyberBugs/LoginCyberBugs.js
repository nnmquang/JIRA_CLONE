      ...
      <div className="mt-12">
        <form onSubmit={handleSubmit}>
          <div>
            ...
            className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  placeholder="mike@gmail.com" />
          ...
          <div className="mt-8">
            ...
            <input
              ...
              onChange={handleChange} 
              value={values.firstName} 
              className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  placeholder="Enter your password" />
